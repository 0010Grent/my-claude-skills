...
```bash
/plugin marketplace add 0010Grent/my-claude-skills
/plugin install my-skills@0010Grent-my-claude-skills
```

安装后运行 `/reload-plugins`，Skills 即可生效。

> Skills 以 `my-skills:` 为命名空间，例如 `/my-skills:github-push`。

### 更新

```bash
/plugin marketplace update 0010Grent-my-claude-skills
/reload-plugins
```
